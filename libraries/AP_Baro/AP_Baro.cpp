...
const AP_Param::GroupInfo AP_Baro::var_info[] = {
    ...
    // @Bitmask: 0:BMP085,1:BMP280,2:MS5611,3:MS5607,4:MS5637,5:FBM320,6:DPS280,7:LPS25H,8:Keller,9:MS5837,10:BMP388,11:SPL06,12:MSP,13:BMP581,14:AUAV,15:ABP2
    // @User: Advanced
...
void AP_Baro::_probe_i2c_barometers(void)
{
    ...
    static const struct BaroProbeSpec {
        ...
        { PROBE_ABP2, AP_Baro_ABP2::probe, HAL_BARO_ABP2_I2C_ADDR },
#endif
